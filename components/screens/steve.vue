    ...
    <scroll-view>
        <view class="member">
            <image
                ...
                :source="{uri: 'https://wallpapersmug.com/large/27e8f9/avengers-infinity-war-chris-evans-steve-rogers-captain.jpg'}"
            />
            <text class="member_title">Captain America aka Steve Rogers</text>
            <text class="member_details">
